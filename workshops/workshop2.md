...
#### Task 4b
1. Use Reaper to download 200 HTML comments based on relevence from the last 50 videos on the YouTube channel "Smarter Every Day". Note that you may have to download one set of data before you can create the second. Ensure that each comment has a column describing what video it is from
2. Import the data into OpenRefine
